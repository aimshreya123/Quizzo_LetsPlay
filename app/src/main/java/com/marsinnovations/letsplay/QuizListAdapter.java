...
public class QuizListAdapter extends RecyclerView.Adapter<QuizListAdapter.QuizViewHolder> {
    ...
    public void onBindViewHolder(@NonNull QuizViewHolder holder, int position) {
        ...
        holder.listDesc.setText(quizListModels.get(position).getDescription());
    ...
    public class QuizViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public QuizViewHolder(@NonNull View itemView) {
            ...
            listImage = itemView.findViewById(R.id.quizImage);
            listTitle = itemView.findViewById(R.id.quizTitle);
            listDesc = itemView.findViewById(R.id.quizDescription);
            listLevel = itemView.findViewById(R.id.quizDifficulty);
            listBtn = itemView.findViewById(R.id.button);
